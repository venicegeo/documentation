...
* 201 Spear Street: `/v1/search/explorer/?query=search/structured&address=201 Spear Street&locality=San Francisco&region=CA`
* Rue de Rivoli: `/v1/search/explorer/?query=search/structured&address=Rue de Rivoli&locality=Paris&region=France`
* Přílucká 1: `/v1/search/explorer/?query=search/structured&address=1 Přílucká&locality=Želechovice nad Dřevnicí`
...
* Notting Hill in London: `/v1/search/explorer/?query=search/structured&neighbourhood=Notting Hill&locality=London`
* Flatiron District in Manhattan: `/v1/search/explorer/?query=search/structured&neighbourhood=Flatiron District&borough=Manhattan`
* Le Marais: in Paris `/v1/search/explorer/?query=search/structured&neighbourhood=Le Marais&locality=Paris`
...
* Manhattan: `/v1/search/explorer/?query=search/structured&borough=Manhattan&locality=New York`
* Iztapalapa: `/v1/search/explorer/?query=search/structured&borough=Iztapalapa&locality=Mexico City`
...
* Bangkok: `/v1/search/explorer/?query=search/structured&locality=Bangkok&country=Thailand`
* Caracas: `/v1/search/explorer/?query=search/structured&locality=Caracas&country=Venezuela`
* Truth or Consequences: `/v1/search/explorer/?query=search/structured&locality=Truth or Consequences&region=NM` in New Mexico
...
* Bucks: `/v1/search/explorer/?query=search/structured&county=Bucks&region=PA` in Pennsylvania
* Maui: `/v1/search/explorer/?query=search/structured&county=Maui&region=HI`
* Alb-Donau-Kreis: `/v1/search/explorer/?query=search/structured&county=Alb-Donau-Kreis&country=DEU` in Germany
...
* Delaware: `/v1/search/explorer/?query=search/structured&region=Delaware`
* Ontario: `/v1/search/explorer/?query=search/structured&region=Ontario`
* Ardennes: `/v1/search/explorer/?query=search/structured&region=Ardennes`
...
* Liechtenstein: `/v1/search/explorer/?query=search/structured&country=Liechtenstein`
* CMR: `/v1/search/explorer/?query=search/structured&country=CMR` ([Cameroon](https://spelunker.whosonfirst.org/id/85632245/))
* Bermuda: `/v1/search/explorer/?query=search/structured&country=Bermuda`
